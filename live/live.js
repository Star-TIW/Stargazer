document.addEventListener("DOMContentLoaded", () => {
  ...
  if (!gamesList) {
    ...
    gamesList = document.createElement("div");
  ...
  async function fetchNFLGamesWindow() {
    ...
    try {
      ...
      //   competitions: [{
      //     competitors: [
      //       { homeAway: "home", team: { displayName: "Test Home", abbreviation: "TH", logo: "/star.png" }, score: 13 },
      //       { homeAway: "away", team: { displayName: "Test Away", abbreviation: "TA", logo: "/star.png" }, score: 7 }
      //     ],
      //     status: { type: { shortDetail: "Delayed" } }
      //   }]
      // });
        ...
        try {
          ...
          card.innerHTML = `
            ...
            <div style="margin-top:10px; display:flex; gap:8px; justify-content:center;">
              <button class="watch-btn">Available 30 mins before kickoff</button>
            </div>
          `;
          ...
          console.error("live.js: error rendering event", ev && ev.id, innerErr);
        }
      });
      ...
      gamesList.innerHTML = `<div class="game-card"><p style="text-align:center; color:#efef88;">Could not load games.</p></div>`;
    }
  }
